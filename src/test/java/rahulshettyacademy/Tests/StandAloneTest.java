...
public class StandAloneTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//loginpage
		driver.findElement(By.id("userEmail")).sendKeys("samroy123@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("India@11");
		...
		js.executeScript("window.scroll(1049, 563)");
